@echo off
REM ============================================================================
REM CODESYS Project Generator - Local Development Launcher
REM ============================================================================
REM Author: Alexander Fugmann
REM Description: Loads configuration from ProjectGenerator_Config_Local.ini
REM ============================================================================
...
set "CONFIG_FILE=%~dp0ProjectGenerator_Config_Local.ini"
...
echo    ================================================
echo.
echo         CODESYS Project Generator (Local)
echo    ================================================
echo.
...
if not exist "%CONFIG_FILE%" (
    ...
    echo           %CONFIG_FILE%
    echo.
    echo    [HINT] Create ProjectGenerator_Config_Local.ini in same directory
    echo.
    goto :ERROR_EXIT
)
...
if not defined SCRIPT_DIR set "SCRIPT_DIR=D:\WAGO\CODESYS\scripting\project generator"
if not defined DEFAULT_SCRIPT set "DEFAULT_SCRIPT=codesys_project_generator_local.py"
if not defined LOG_DIR set "LOG_DIR=D:\WAGO\CODESYS\scripting\project generator\logs"
